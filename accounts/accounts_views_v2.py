...
def register(request):
    if request.method == 'POST':
        ...
        User.objects.create_user(username=username, email=email, password=password1, role='citizen')
...
def authority_register(request):
    if request.method == 'POST':
        ...
        user = User.objects.create_user(username=username, email=email, password=password1, role='authority')
...
def dashboard(request):
    ...
    if request.user.role == 'citizen':
        ...
        # Count overdue complaints for the warning banner
